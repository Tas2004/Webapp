...
def save_EDA_preprocessing(eda_phasic, eda_tonic):
    ...
    preprocessing_data = {
        "EDA_Phasic": float(eda_phasic) if eda_phasic is not None else None,
        "EDA_Tonic": float(eda_tonic) if eda_tonic is not None else None,
    ...
    print("--------------------------------------------------------------------------------------------------")
    print(f"EDA Preprocessing data saved: Phasic={eda_phasic}, Tonic={eda_tonic}")
    print("--------------------------------------------------------------------------------------------------")
